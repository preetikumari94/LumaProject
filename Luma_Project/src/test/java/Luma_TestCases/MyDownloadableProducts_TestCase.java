...
import Luma.pages.MyDownloadableProducts_page;
import Luma.pages.Signin_page;
import Luma.pages.Signout_page;

public class MyDownloadableProducts_TestCase {
	WebDriver driver;
	Signin_page si;
	Signout_page so;
	 MyAccount_page ma;
	 MyDownloadableProducts_page md;
	...
	public void launchBrowser(){
        ...
        MyDownloadableProducts_page md=new  MyDownloadableProducts_page (driver);
               ...
               ma.clickMyAccount();
               md.clickMyDownloadableProducts();
